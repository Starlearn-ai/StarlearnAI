...
const steps = [
  {
    ...
    title: "Enter Topics",
    description: "Provide your main topic or optionally a list of subtopics.",
    color: "from-primary/20 to-primary/5"
  },
  {
    icon: <Cpu className="h-6 w-6 text-primary" />,
    title: "Choose Preferences",
    description: "Learn with images or video?",
    color: "from-primary/30 to-primary/10"
  },
  {
    icon: <Layout className="h-6 w-6 text-primary" />,
    title: "Select your preferred language.",
    description: "Generate courses in over 23 languages.",
    color: "from-primary/40 to-primary/20"
  },
  {
    icon: <CheckCircle className="h-6 w-6 text-primary" />,
    title: "AI Generates",
    description: "Crafting your learning experience...",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 md:mb-20">
          ...
          <h2 className="how-it-works-title opacity-0 font-display text-3xl md:text-4xl lg:text-5xl font-bold">
            Simple <span className="text-primary">Four-Step</span> Course Generation
          </h2>
        </div>

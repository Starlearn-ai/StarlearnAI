          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold mb-2">What is StarlearnAI?</h3>
                  <p className="text-muted-foreground">
                    StarlearnAI is an innovative education technology company that provides personalized, AI-powered courses on a wide range of topics. 
                  </p>
                </div>

                <div>
                  <h3 className="text-lg font-semibold mb-2">Who can benefit from StarlearnAI's courses?</h3>
                  <p className="text-muted-foreground">
                    StarlearnAI is designed for a broad audience, including:
                    Individuals looking to upskill or reskill for new career opportunities.
                    Professionals seeking to enhance their current skill set and stay competitive.
                    Businesses looking to train their employees and improve team capabilities.
                    Anyone eager to learn new topics and gain practical, in-demand skills.
                  </p>
                </div>
